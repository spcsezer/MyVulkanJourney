...
void InitVulkan::createGraphicsPipeline()
{
	...
	rasterizer.depthClampEnable = VK_FALSE; //If is set to TRUE then it is good for shadow maps
	rasterizer.rasterizerDiscardEnable = VK_FALSE; //If is set to TRUE THEN GEOMETRY NEVER PASS.
...
int InitVulkan::rateDeviceSuitability(VkPhysicalDevice device)
{
...
VkSurfaceFormatKHR InitVulkan::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
